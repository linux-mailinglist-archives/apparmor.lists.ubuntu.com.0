...
Received: from huckleberry.canonical.com (huckleberry.canonical.com [91.189.94.19])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A706247E49
	for <lists+apparmor@lfdr.de>; Tue, 18 Aug 2020 08:11:46 +0200 (CEST)
Received: from localhost ([127.0.0.1] helo=huckleberry.canonical.com)
	by huckleberry.canonical.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1k7uKH-0000JQ-Ji; Tue, 18 Aug 2020 05:38:25 +0000
Received: from mail-ej1-f65.google.com ([209.85.218.65])
 by huckleberry.canonical.com with esmtps
 (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128) (Exim 4.86_2)
 (envelope-from <murali.selvaraj2003@gmail.com>) id 1k5GVy-000399-W9
 for apparmor@lists.ubuntu.com; Mon, 10 Aug 2020 22:43:35 +0000
Received: by mail-ej1-f65.google.com with SMTP id o23so11047303ejr.1
 for <apparmor@lists.ubuntu.com>; Mon, 10 Aug 2020 15:43:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=SOtG0QmL05DNxteenXaVHSYPJ7nmugNOuZTOQzzOzrA=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=SOtG0QmL05DNxteenXaVHSYPJ7nmugNOuZTOQzzOzrA=;
 b=
X-Gm-Message-State: AOAM5335tvlHrI3wNeYhBkFMdxCrI2sJazRGrUZw8fKUVWraJCYA1eXC
 gt4kbCWbGlWHetrzYS2p+GgRpWNQRd6s+Qykk9U=
X-Google-Smtp-Source: ABdhPJymw3/QYusoRUaQ35AM4DB8n+D+m7uM4ZPHHes+Gc28k+cA1dBvqLJE6fzwoStFcX6x7vWL9jJW7tj8C8UY3dk=
X-Received: by 2002:a17:906:73d9:: with SMTP id
 n25mr5684932ejl.412.1597099414201; 
 Mon, 10 Aug 2020 15:43:34 -0700 (PDT)
MIME-Version: 1.0
...
Date: Mon, 10 Aug 2020 18:43:23 -0400
Message-ID: <CAODFaZ7FLLJd-4pPnfdc-KL=vHKeuR9rGWT1G8s_Q0gDWfeTCA@mail.gmail.com>
To: John Johansen <john.johansen@canonical.com>
Received-SPF: pass client-ip=209.85.218.65;
 envelope-from=murali.selvaraj2003@gmail.com; helo=mail-ej1-f65.google.com
...
Content-Type: multipart/mixed; boundary="===============3872120475307226067=="
Errors-To: apparmor-bounces@lists.ubuntu.com
Sender: "AppArmor" <apparmor-bounces@lists.ubuntu.com>

--===============3872120475307226067==
Content-Type: multipart/alternative; boundary="0000000000004128cb05ac8dafdc"

--0000000000004128cb05ac8dafdc
...
>
> - We are planning to enable CAP_DAC_OVERRIDE, CAP_DAC_READ_SEARCH CAPs
> when the process switches to non-root.
...
> CAP_DAC_READ_SEARCH, CAP_NET_ADMIN, CAP_SYS_ADMIN to run
> the process in non-root to ensure it works in the same way when it was
> running in "root".
>
> Do you think enabling CAP_DAC_OVERRIDE, CAP_DAC_READ_SEARCH,
> CAP_NET_ADMIN, CAP_SYS_ADMIN in the process
...
>> capabilities for the process.
>> >
>> > Scope: Am trying to find out required capabilities for the process
>> which is going to run as "non-root"
>> >
...
>> capabilities.
>> >
>> > -> We had thought that, from apparmor logs, we would be able to find
...
>> > Capture these CAPS and use this CAPS in the process code to convert
>> that process root to non-root by only enabling this CAPs observed in
>> apparmor logs.
>> >
...
>>        if ( not capable (CAP))
>>          return fail;    }
>>     if ( not APPARMOR_CAP(CAP))              <---- AppArmor will log if
>> we get here
>>        return fail;
>>   }
>>
...
>>
>> > In such a case, trying to understand when Kernel uses capable() to
>> check CAP_DAC_READ_SEARCH/CAP_DAC_OVERRIDE before/after DAC.
>>
...
>> >     >
>> >     > I do not see a capability difference when this script runs in
>> root (UID:0)  and nobody (UID>0).
>> >     > If we are observing the required capabilities when the script
>> runs in root, that would be easy for us to find
...
>> >     > while [ 1 ]
>> >     > do
>> >     > cat /etc/foo   =================> Ensure this file belongs to
>> root permission
...
>> >     >    So, we need to set appropriate capabilities in order to run
>> the application successfully in "non-root".
>> >     >
>> >     yes
>> >
...
>> compliant mode.
>> >
>> >     this doesn't quite work but you will be able to collect
>> capabilities that don't rely on a uid check. This is because of how the
>> kernel doesn't always apply a capability check, Eg. for kill CAPS are not
>> always checked in the same way when subject uid == object uid vs. subject
>> uid != object uid. The same can be said for DAC_OVERRIDE, DAC_READSEARCH,
>> ...
>> >
...
>> >
>> >
>> >     >    Once we get the CAPs list from Apparmor logs, then we shall
>> use the same required CAPS only ( NOT all the CAPs) for the
...
>> >     >     > Query 1:
>> >     >     >
>> >     >     > - But I do not see CAP_DAC_OVERRIDE and CAP_KILL in
>> apparmor event logs.
>> >     >
...
>> >     >
>> >     >     You'll only see these requests in AppArmor logs if the
>> process had these
...
>> there may be
>> >     >     different users within the guest, and the 'root' user with
>> the LXD guest
>> >     >     can do privileged operations over the namespace, eg manage
>> the routing
...
;padding-left:1ex"><div dir=3D"ltr"><div dir=3D"ltr">Hi John, Seth,=C2=A0<b=
r><br>Thanks again for the details. I would like to get your inputs and cla=
rify my understanding.</div><div dir=3D"ltr">Please go through the trailing=
 email and correct me if I am wrong.<br><br><b>Goal:</b> Reducing root perm=
ission of the process and enabling required capabilities for the process.<b=
r><br><b>Design and approach:</b><br><br>- To identify the required CAPs fo=
r the process, we are planning to enable all CAPs while running in &quot;no=
n-root&quot;<br>=C2=A0 mode and from apparmor logs, hopefully we would be a=
ble to find the required capability list for the process<br>=C2=A0 specific=
.<br><br>- Please note that our user &quot;non-root&quot; (UID) is fixed. w=
e won&#39;t change the user UID and GID for non-root.<br><br><b>Implementat=
ion:</b><br><br>- Process would be starting as &quot;root&quot; and droppin=
g to non-root then applying required CAPs based on above apparmor logs<br>=
=C2=A0 using libcap APIs.<br><br>- Most of the process needs CAP_DAC_OVERRI=
DE, CAP_DAC_READ_SEARCH to read/write root privilege files/directories.<br>=
<br><b>Query specific to above non-root approach:=C2=A0</b><br><br>- We are=
 planning to enable CAP_DAC_OVERRIDE, CAP_DAC_READ_SEARCH CAPs when the pro=
cess switches to non-root.<br>- Then based on a process for example network=
 specific process, we will enable CAP_NET_ADMIN.<br>- In case of system spe=
cific processes to access hardware details, we will enable CAP_SYS_ADMIN.<b=
r>- Please note, we will require CAPs based on apparmor logs as indicated a=
bove.<br><br>Here, the doubt is that if we enable CAP_DAC_OVERRIDE, CAP_DAC=
_READ_SEARCH, CAP_NET_ADMIN, CAP_SYS_ADMIN to run<br>the process in non-roo=
t to ensure it works in the same way when it was running in &quot;root&quot=
;.<br><br>Do you think enabling CAP_DAC_OVERRIDE, CAP_DAC_READ_SEARCH, CAP_=
NET_ADMIN, CAP_SYS_ADMIN in the process<br>are we missing any security or t=
his is expected while using Linux capabilities for non-root (dropping root =
privilege).<br><br>Please share your valuable suggestions on security speci=
fic views.<br><br><b>General query:</b><br><br>- Is Linux capabilities belo=
ng to DAC or LSM/MAC? <br>As per my understanding, Linux capabilities are p=
art of LSM. But I still think that few CAPs are used in DAC.<br>Please shar=
e the details with example.<br><br>- Is LSM mandatory to enable in Linux Ke=
rnel?<br><br>- Which LSM is enabled in linux by default?<br><br>- Why do we=
 need MAC as we have a security check by discretionary access controls (DAC=
) ?<br>Is MAC mandatory to enable or optional?<br><br>- Is MAC really manda=
tory for Linux? AS per my understanding, for embedded linux devices no need=
 to enable MAC on production devices.<br>=C2=A0<br>Thanks</div><div>Murali.=
S</div><div><br></div><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"=
gmail_attr">On Wed, Aug 5, 2020 at 3:25 AM John Johansen &lt;<a href=3D"mai=
lto:john.johansen@canonical.com" target=3D"_blank">john.johansen@canonical.=
com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"marg=
in:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1e=
x">On 8/4/20 7:46 PM, Murali Selvaraj wrote:<br>
