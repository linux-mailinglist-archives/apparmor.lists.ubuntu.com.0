...
Received: from huckleberry.canonical.com (huckleberry.canonical.com [91.189.94.19])
	by mail.lfdr.de (Postfix) with ESMTPS id 18DBA748E2E
	for <lists+apparmor@lfdr.de>; Wed,  5 Jul 2023 21:45:08 +0200 (CEST)
Received: from localhost ([127.0.0.1] helo=huckleberry.canonical.com)
	by huckleberry.canonical.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1qH8Qv-0007Hz-8G; Wed, 05 Jul 2023 19:45:01 +0000
Received: from dfw.source.kernel.org ([139.178.84.217])
 by huckleberry.canonical.com with esmtps
 (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128) (Exim 4.86_2)
 (envelope-from <jlayton@kernel.org>) id 1qH7iY-0004Oi-GQ
 for apparmor@lists.ubuntu.com; Wed, 05 Jul 2023 18:59:10 +0000
...
Subject: [apparmor] [PATCH v2 08/92] fs: new helper: simple_rename_timestamp
