...
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id DFE0A7F87A4
	for <lists+apparmor@lfdr.de>; Sat, 25 Nov 2023 03:05:40 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1r6i2v-0003jB-HE; Sat, 25 Nov 2023 02:05:25 +0000
Received: from smtp-relay-canonical-0.internal ([10.131.114.83]
 helo=smtp-relay-canonical-0.canonical.com)
 by lists.ubuntu.com with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.86_2) (envelope-from <john.johansen@canonical.com>)
 id 1r6i2n-0003is-7x
 for apparmor@lists.ubuntu.com; Sat, 25 Nov 2023 02:05:17 +0000
Received: from [192.168.192.84] (unknown [50.39.103.33])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-relay-canonical-0.canonical.com (Postfix) with ESMTPSA id 480EE3F280
 for <apparmor@lists.ubuntu.com>; Sat, 25 Nov 2023 02:05:16 +0000 (UTC)
Message-ID: <836e1ad9-a3a6-4f2e-9d4a-a812876699d6@canonical.com>
Date: Fri, 24 Nov 2023 18:05:13 -0800
MIME-Version: 1.0
...
Subject: Re: [apparmor] [PATCH] apparmor: make stack_msg static
