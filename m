...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gLYzCahgpmnUOwAAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:16:40 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 116391E8ABD
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:16:40 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vxHBU-0000pg-At; Tue, 03 Mar 2026 04:16:36 +0000
Received: from sea.source.kernel.org ([172.234.252.31])
 by lists.ubuntu.com with esmtp (Exim 4.86_2)
 (envelope-from <jlayton@kernel.org>) id 1vxAIP-0007Ux-J6
...
Subject: [apparmor] [PATCH v2 087/110] isofs: replace PRIino with %llu/%llx
 format strings
