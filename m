...
Received: from sonic311-30.consmr.mail.ne1.yahoo.com ([66.163.188.211])
 ...
 id 1vxU8f-0004A4-Ov
 for apparmor@lists.ubuntu.com; Tue, 03 Mar 2026 18:06:34 +0000
...
X-Rspamd-Queue-Id: 5A4CC1F6827
X-Rspamd-Server: lfdr
X-Spamd-Result: default: False [1.59 / 15.00];
	SUSPICIOUS_RECIPS(1.50)[];
	R_DKIM_REJECT(1.00)[yahoo.com:s=s2048];
 ...
 uniyu@google.com,m:pabeni@redhat.com,m:willemb@google.com,m:davem@davemloft.net,m:kuba@kernel.org,m:horms@kernel.org,m:oleg@redhat.com,m:peterz@infradead.org,m:mingo@redhat.com,m:acme@kernel.org,m:namhyung@kernel.org,m:mark.rutland@arm.com,s:lists@lfdr.de];
	...
	MIME_TRACE(0.00)[0:+];
	FORGED_SENDER(0.00)[casey@schaufler-ca.com,apparmor-bounces@lists.ubuntu.com];
	TO_DN_SOME(0.00)[];
	ARC_NA(0.00)[];
	...
	FROM_NEQ_ENVFROM(0.00)[casey@schaufler-ca.com,apparmor-bounces@lists.ubuntu.com];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[schaufler-ca.com:mid,schaufler-ca.com:email]
