...
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id C6D20AECC52
	for <lists+apparmor@lfdr.de>; Sun, 29 Jun 2025 13:41:06 +0200 (CEST)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1uVqOv-0003bn-TK; Sun, 29 Jun 2025 11:40:49 +0000
Received: from smtp-relay-canonical-1.internal ([10.131.114.174]
 helo=smtp-relay-canonical-1.canonical.com)
 by lists.ubuntu.com with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.86_2) (envelope-from <john.johansen@canonical.com>)
 id 1uVqOu-0003bg-B6
 for apparmor@lists.ubuntu.com; Sun, 29 Jun 2025 11:40:48 +0000
Received: from [192.168.192.84] (unknown [50.47.147.87])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-relay-canonical-1.canonical.com (Postfix) with ESMTPSA id 64C603FF0B; 
 Sun, 29 Jun 2025 11:40:45 +0000 (UTC)
Message-ID: <02e06dd2-a5da-42c0-aa2e-97317d4bc5b8@canonical.com>
Date: Sun, 29 Jun 2025 04:40:44 -0700
MIME-Version: 1.0
User-Agent: Mozilla Thunderbird
To: Ryan Lee <ryan.lee@canonical.com>, apparmor@lists.ubuntu.com
References: <20250623215802.147652-1-ryan.lee@canonical.com>
...
In-Reply-To: <20250623215802.147652-1-ryan.lee@canonical.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
Subject: Re: [apparmor] [PATCH] apparmor: remove redundant perms.allow
 MAY_EXEC bitflag set
