...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mDq4C6NzqmkfRwEAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Fri, 06 Mar 2026 07:26:43 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id A728721C0DA
	for <lists+apparmor@lfdr.de>; Fri, 06 Mar 2026 07:26:42 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vyO6t-0007yR-RG; Fri, 06 Mar 2026 05:52:27 +0000
Received: from sea.source.kernel.org ([172.234.252.31])
 by lists.ubuntu.com with esmtp (Exim 4.86_2)
 (envelope-from <jlayton@kernel.org>) id 1vxoPa-0004Du-OP
 for apparmor@lists.ubuntu.com; Wed, 04 Mar 2026 15:45:23 +0000
...
Subject: [apparmor] [PATCH v3 12/12] treewide: change inode->i_ino from
...
X-Spamd-Result: default: False [4.09 / 15.00];
 ...
 :pabeni@redhat.com,m:willemb@google.com,m:davem@davemloft.net,m:kuba@kernel.org,m:horms@kernel.org,m:oleg@redhat.com,m:peterz@infradead.org,m:mingo@redhat.com,m:acme@kernel.org,m:namhyung@kernel.org,m:mark.rutland@arm.com,m:alexander.shishkin@linux.intel.com,s:lists@lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[str.name:url,lists.ubuntu.com:rdns,lists.ubuntu.com:helo]
