...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id wKAJDjFzqmkWRwEAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Fri, 06 Mar 2026 07:24:49 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id A76FE21C090
	for <lists+apparmor@lfdr.de>; Fri, 06 Mar 2026 07:24:48 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vyO6u-0007yf-B8; Fri, 06 Mar 2026 05:52:28 +0000
Received: from smtp-out1.suse.de ([195.135.223.130])
 by lists.ubuntu.com with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.86_2) (envelope-from <jack@suse.cz>) id 1vy5Sx-0002vV-7R
 for apparmor@lists.ubuntu.com; Thu, 05 Mar 2026 09:57:59 +0000
...
X-Spam-Level: 
X-Spam-Flag: NO
Received-SPF: pass client-ip=195.135.223.130; envelope-from=jack@suse.cz;
...
X-Spamd-Result: default: False [2.09 / 15.00];
 ...
 d.com,m:alexander.shishkin@linux.intel.com,m:ocfs2-devel@lists.linux.dev,m:ast@kernel.org,m:linux-mtd@lists.infradead.org,m:marc.dionne@auristor.com,m:ncardwell@google.com,m:linux-afs@lists.infradead.org,m:raven@themaw.net,m:naohiro.aota@wdc.com,m:ebiggers@kernel.org,m:daniel@iogearbox.net,m:miklos@szeredi.hu,m:amd-gfx@lists.freedesktop.org,m:coda@cs.cmu.edu,m:sdf@fomichev.me,m:slava@dubeyko.com,m:neil@brown.name,s:lists@lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[suse.cz:email,lists.ubuntu.com:rdns,lists.ubuntu.com:helo,str.name:url]
