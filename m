...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8HauK6lgpmnSOwAAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:16:41 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id A31521E8AF7
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:16:41 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vxHBT-0000mu-4m; Tue, 03 Mar 2026 04:16:35 +0000
Received: from sea.source.kernel.org ([172.234.252.31])
 by lists.ubuntu.com with esmtp (Exim 4.86_2)
 (envelope-from <jlayton@kernel.org>) id 1vxADZ-0005V0-BL
...
Subject: [apparmor] [PATCH v2 078/110] cramfs: replace PRIino with %llu/%llx
 format strings
