...
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 066F58FA640
	for <lists+apparmor@lfdr.de>; Tue,  4 Jun 2024 01:13:24 +0200 (CEST)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1sEGrW-0004HA-T7; Mon, 03 Jun 2024 23:13:10 +0000
Received: from mgamail.intel.com ([192.198.163.13])
 by lists.ubuntu.com with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.86_2) (envelope-from <andriy.shevchenko@linux.intel.com>)
 id 1sEF2j-0006Ll-Rm
 for apparmor@lists.ubuntu.com; Mon, 03 Jun 2024 21:16:38 +0000
X-CSE-ConnectionGUID: s2TmlCkGRxGD1/Xc3Dr4Dg==
X-CSE-MsgGUID: NCGczZqsQoCcn2+M4q3m+A==
X-IronPort-AV: E=McAfee;i="6600,9927,11092"; a="16903784"
X-IronPort-AV: E=Sophos;i="6.08,212,1712646000"; d="scan'208";a="16903784"
...
Subject: [apparmor] [PATCH v1 1/1] treewide: Align match_string() with
	sysfs_match_string()
