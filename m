...
Received: from ip72-198-198-28.om.om.cox.net ([72.198.198.28]:60158
...
X-XM-SPF: eid=1uFE8j-006IWS-AS; ; ;
 mid=<87r00rw6jc.fsf@email.froward.int.ebiederm.org>; ; ;
...
X-Spam-Status: No, score=6.0 required=8.0 tests=ALL_TRUSTED,BAYES_50,
 ...
 T_XMDrugObfuBody_08,XMGenDplmaNmb,XMNoVowels,XMSubLong,
 XM_B_Phish_Phrases,XM_B_Unicode,XM_Body_Dirty_Words autolearn=disabled
 version=3.4.2
...
Received-SPF: pass client-ip=166.70.13.233; envelope-from=ebiederm@xmission.com;
