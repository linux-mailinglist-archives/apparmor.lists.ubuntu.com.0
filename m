...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sAkEC+DqoWkdxQQAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Fri, 27 Feb 2026 20:05:04 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A8591BC635
	for <lists+apparmor@lfdr.de>; Fri, 27 Feb 2026 20:05:04 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vw2pd-00046b-T2; Fri, 27 Feb 2026 18:44:57 +0000
Received: from tor.source.kernel.org ([172.105.4.254])
 by lists.ubuntu.com with esmtp (Exim 4.86_2)
 (envelope-from <ebiggers@kernel.org>) id 1vvf2Q-0000sH-Mg
 for apparmor@lists.ubuntu.com; Thu, 26 Feb 2026 17:20:34 +0000
...
Subject: Re: [apparmor] [PATCH 57/61] fscrypt: update format strings for u64
	i_ino
...
X-Spamd-Result: default: False [4.59 / 15.00];
	...
	FORGED_SENDER(0.00)[ebiggers@kernel.org,apparmor-bounces@lists.ubuntu.com];
 ...
 cs.cmu.edu,m:slava@dubeyko.com,m:neil@brown.name,m:idryomov@gmail.com,m:pabeni@redhat.com,m:serge@hallyn.com,m:amir73il@gmail.com,m:james.clark@linaro.org,m:autofs@vger.kernel.org,m:rostedt@goodmis.org,m:dlemoal@kernel.org,m:mathieu.desnoyers@efficios.com,m:dan.j.williams@intel.com,m:osalvador@suse.de,m:almaz.alexandrovich@paragon-software.com,m:linux-nfs@vger.kernel.org,m:linux-ext4@vger.kernel.org,m:linux-mm@kvack.org,m:samba-technical@lists.samba.org,s:lists@lfdr.de];
	...
	FROM_HAS_DN(0.00)[];
	FROM_NEQ_ENVFROM(0.00)[ebiggers@kernel.org,apparmor-bounces@lists.ubuntu.com];
