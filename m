...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id wGKcEwtmpmljPQAAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:39:39 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 3612C1E8E31
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:39:39 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vxHCt-0006hZ-Si; Tue, 03 Mar 2026 04:18:03 +0000
Received: from sea.source.kernel.org ([172.234.252.31])
 by lists.ubuntu.com with esmtp (Exim 4.86_2)
 (envelope-from <jlayton@kernel.org>) id 1vxAIR-0007Vl-EP
...
Subject: [apparmor] [PATCH v2 088/110] jffs2: replace PRIino with %llu/%llx
 format strings
