...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OPo1FUxmpmljPQAAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:40:44 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 26F0E1E8E65
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:40:44 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vxHCp-0006Fm-6O; Tue, 03 Mar 2026 04:17:59 +0000
Received: from tor.source.kernel.org ([172.105.4.254])
 by lists.ubuntu.com with esmtp (Exim 4.86_2)
 (envelope-from <jlayton@kernel.org>) id 1vxADw-0005wN-Bt
...
Subject: [apparmor] [PATCH v2 069/110] 9p: replace PRIino with %llu/%llx
 format strings
