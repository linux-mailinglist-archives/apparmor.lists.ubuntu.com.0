...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gGhiJqdgpmnWOwAAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:16:39 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 514AA1E8A9D
	for <lists+apparmor@lfdr.de>; Tue, 03 Mar 2026 05:16:39 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vxHBS-0000ls-JL; Tue, 03 Mar 2026 04:16:34 +0000
Received: from tor.source.kernel.org ([172.105.4.254])
 by lists.ubuntu.com with esmtp (Exim 4.86_2)
 (envelope-from <jlayton@kernel.org>) id 1vxA96-0004A4-1F
...
Subject: [apparmor] [PATCH v2 062/110] jbd2: replace PRIino with %llu/%llx
 format strings
