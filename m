...
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 05603C1F73A
	for <lists+apparmor@lfdr.de>; Thu, 30 Oct 2025 11:08:00 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vEPZL-0006e3-GO; Thu, 30 Oct 2025 10:07:47 +0000
Received: from flow-b4-smtp.messagingengine.com ([202.12.124.139])
 by lists.ubuntu.com with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.86_2) (envelope-from <neilb@ownmail.net>) id 1vEFr8-0004on-Fn
 for apparmor@lists.ubuntu.com; Wed, 29 Oct 2025 23:45:30 +0000
...
Subject: [apparmor] [PATCH v4 04/14] VFS/nfsd/cachefiles/ovl: add
	start_creating() and end_creating()
