...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OHqpIdFZsGmMiQIAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Tue, 10 Mar 2026 18:50:09 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 45FB4255E05
	for <lists+apparmor@lfdr.de>; Tue, 10 Mar 2026 18:50:09 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vzzmb-0001Xy-P8; Tue, 10 Mar 2026 16:18:09 +0000
Received: from metis.whiteo.stw.pengutronix.de ([185.203.201.7])
 by lists.ubuntu.com with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.86_2) (envelope-from <p.zabel@pengutronix.de>)
 id 1vzwQv-0008Pr-QE
 for apparmor@lists.ubuntu.com; Tue, 10 Mar 2026 12:43:33 +0000
...
X-PTX-Original-Recipient: apparmor@lists.ubuntu.com
Received-SPF: pass client-ip=185.203.201.7;
 envelope-from=p.zabel@pengutronix.de; helo=metis.whiteo.stw.pengutronix.de
...
X-Spamd-Result: default: False [0.59 / 15.00];
 ...
 l.org,m:linux-phy@lists.infradead.org,m:linux-pm@vger.kernel.org,m:linux-rockchip@lists.infradead.org,m:linux-s390@vger.kernel.org,m:linux-scsi@vger.kernel.org,m:linux-sctp@vger.kernel.org,m:linux-security-module@vger.kernel.org,m:linux-sh@vger.kernel.org,m:linux-sound@vger.kernel.org,m:linux-stm32@st-md-mailman.stormreply.com,m:linux-trace-kernel@vger.kernel.org,m:linux-usb@vger.kernel.org,m:linux-wireless@vger.kernel.org,m:netdev@vger.kernel.org,m:ntfs3@lists.linux.dev,m:samba-technical@lists.samba.org,m:sched-ext@lists.linux.dev,m:target-devel@vger.kernel.org,m:tipc-discussion@lists.sourceforge.net,m:v9fs@lists.linux.dev,s:lists@lfdr.de];
	...
	ARC_NA(0.00)[];
	FORGED_SENDER(0.00)[p.zabel@pengutronix.de,apparmor-bounces@lists.ubuntu.com];
	...
	FROM_NEQ_ENVFROM(0.00)[p.zabel@pengutronix.de,apparmor-bounces@lists.ubuntu.com];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.ubuntu.com:rdns,lists.ubuntu.com:helo,pengutronix.de:mid]
