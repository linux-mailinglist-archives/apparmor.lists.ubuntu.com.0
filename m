...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CHxWL9qpm2mb4QMAu9opvQ
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	for <lists+apparmor@lfdr.de>; Mon, 23 Feb 2026 02:14:02 +0100
X-Original-To: lists+apparmor@lfdr.de
Received: from lists.ubuntu.com (lists.ubuntu.com [185.125.189.65])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EA8B1711EB
	for <lists+apparmor@lfdr.de>; Mon, 23 Feb 2026 02:14:02 +0100 (CET)
Received: from localhost ([127.0.0.1] helo=lists.ubuntu.com)
	by lists.ubuntu.com with esmtp (Exim 4.86_2)
	(envelope-from <apparmor-bounces@lists.ubuntu.com>)
	id 1vuKWI-00015n-Tc; Mon, 23 Feb 2026 01:13:54 +0000
Received: from flow-a1-smtp.messagingengine.com ([103.168.172.136])
 by lists.ubuntu.com with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.86_2) (envelope-from <neilb@ownmail.net>) id 1vuKWG-00014c-Tr
 for apparmor@lists.ubuntu.com; Mon, 23 Feb 2026 01:13:53 +0000
...
Subject: [apparmor] [PATCH v2 09/15] ovl: Simplify ovl_lookup_real_one()
